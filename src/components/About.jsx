                    ...
                    <div className='mt-10'>
                        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                            <div>
                                ...
                                My journey as a frontend developer began with a curiosity about how websites work, evolving into a passion for creating intuitive user interfaces. I started with HTML, CSS, and JavaScript, advancing to frameworks like React and Bootstrap. Embracing challenges and staying updated with modern technologies, I now craft responsive, accessible, and impactful web applications.
                                </p> 
                            </div>
